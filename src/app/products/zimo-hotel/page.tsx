...
export const metadata: Metadata = {
    ...
    keywords: ["mini app khách sạn", "zalo mini app khách sạn", "phần mềm quản lý khách sạn", "pms hotel", "quản lý nhà nghỉ", "booking engine", "hotel management system", "hotel booking software", "phần mềm đặt phòng khách sạn", "giải pháp quản lý khách sạn", "quản lý khách sạn miễn phí", "phần mềm khách sạn mini", "homestay booking system", "quản lý nhà nghỉ bằng app", "phần mềm quản lý khách sạn trên zalo", "booking app khách sạn miễn phí"],
    alternates: {
