...
export default function Home() {
  return (
    <div className="flex flex-col bg-[var(--base-background)] text-[var(--greyscale-900)] font-sans relative">
      ...
      <section className="relative pt-24 pb-32 overflow-hidden bg-[var(--greyscale-50)]">
        ...
        <div className="container mx-auto px-4 max-w-5xl relative z-10 text-center">
          ...
          >
            ...
            <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-extrabold text-[var(--greyscale-900)] mb-8 leading-tight">
              Kinh doanh thông minh hơn trên <span className="text-[var(--base-primary)] relative">Zalo Mini App.</span>
            </motion.h1>
            <motion.p variants={fadeInUp} className="text-xl text-[var(--greyscale-500)] mb-12 max-w-3xl mx-auto leading-relaxed">
              Hệ thống Zalo Mini App chuyên biệt cho doanh nghiệp SME. Tự động hóa quy trình Đặt lịch - Bán hàng - Tích điểm.
            </motion.p>

            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-5 justify-center mb-16">
              <Button
                variant="primary"
                size="large"
          ...
          <motion.div
            ...
            variants={zoomIn}
            className="mt-16 relative rounded-2xl overflow-hidden shadow-2xl border border-[var(--greyscale-200)] bg-[var(--greyscale-0)] group cursor-pointer"
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-[var(--primary-200)] to-[var(--primary-100)] rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
            <div className="relative">
              ...
              <div className="hidden dark:block">
                <Image
                  src="https://rblawnlhkgwmdbstkhxp.supabase.co/storage/v1/object/public/PublicImage/websiteimg/DashboardDarkmode.png"
                  alt="Zimo Dashboard Dark"
                  width={1400}
                  height={900}
                  className="w-full h-auto"
                  priority
      ...
      <section id="tinh-nang" className="py-24 bg-[var(--greyscale-50)] text-[var(--greyscale-900)] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-16 relative z-10">
          ...
          <motion.div
            ...
            className="lg:w-1/2"
          >
            <motion.h2 variants={fadeInUp} className="text-4xl font-extrabold mb-8 leading-tight">Tại sao chọn Zimo thay vì tự xây dựng App?</motion.h2>
      ...
      <section id="bang-gia" className="py-24 bg-[var(--base-background)]">
        <div className="container mx-auto px-4 text-center">
          <motion.h2
            ...
            viewport={{ once: true }}
            variants={fadeInUp}
            className="text-4xl md:text-5xl font-extrabold text-[var(--greyscale-900)] mb-16"
          >
            Bảng Giá Linh Hoạt
          </motion.h2>
